...
const socialLinks = [
  {
    icon: Github,
    url: "https://github.com/codesayan2004",
  },
  {
    icon: Linkedin,
    url: "https://www.linkedin.com/in/sayan-mandal-iitg/",
  },
  {
    icon: Instagram,
    url: "https://www.instagram.com/sayan_mandal04/",
  },
  {
    icon: Facebook,
    url: "https://www.facebook.com/profile.php?id=100041070313096",
  },
];
    ...
    <section id="contact" className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <form
              action="https://formspree.io/f/mojnwepe"
              method="POST"
              className="space-y-6"
            >
              ...
              <button className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/30 active:scale-95 transition-all">
